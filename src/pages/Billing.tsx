            ...
            <div className="border-t pt-4">
              ...
              <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-800">
                  <strong>Premium Features Unlocked:</strong> All limits removed, unlimited posts, priority support
                </p>
              </div>
            </div>
          )}
      ...
      <Tabs defaultValue="plans" className="space-y-4">
        ...
        <TabsContent value="plans" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            {plans.map((plan) => (
              <Card key={plan.id} className={`relative ${currentPlan?.id === plan.id ? 'border-primary' : plan.popular ? 'border-primary/50' : ''}`}>
                {plan.popular && (
                ...
                <CardContent>
                  ...
                  {currentPlan?.id !== plan.id && (
                    ...
                    >
                      {status === 'active' ? 'Switch Plan' : 'Choose Plan'}
                    </Button>
                  )}
